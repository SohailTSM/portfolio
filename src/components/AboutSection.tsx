        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
          ...
          <motion.div
            ...
            <motion.div variants={itemVariants}>
              ...
              <p className="text-muted-foreground">
                Passionate software engineer focused on clean architecture,
          ...
          <motion.div
            ...
            <motion.div
              ...
              <h3 className="text-2xl font-bold">Sohail Memon</h3>
              <p className="text-muted-foreground">
            ...
            <motion.div
              ...
              <Button className="gap-2" asChild onClick={handledownload}>
                <a href={resumeUrl} download="Sohail_Memon_Resume.pdf">
